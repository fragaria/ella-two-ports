...
from ella_two_ports.cache.invalidate import CACHE_DELETER


log = logging.getLogger('ella_two_ports.cache.utils')

KEY_FORMAT_LIST = 'ella_two_ports.cache.utils.get_cached_list'
KEY_FORMAT_OBJECT = 'ella_two_ports.cache.utils.get_cached_object'
